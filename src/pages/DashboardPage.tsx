            ...
            <Card key={medico.id} className="flex flex-col bg-white rounded-lg shadow-lg overflow-hidden transform hover:scale-105 transition-transform duration-300">
              <div className="p-6 flex-grow">
                ...
                <div className="space-y-4 text-gray-600">
                  <div className="flex items-center">
                    ...
                    <span>
                      <strong>Horário de Atendimento:</strong> {medico.horarioInicio} - {medico.horarioFim}
                    </span>
                  </div>
                    ...
                    <div>
                      ...
                      {datasDoMes.length > 0 ? (
                        <div className="flex flex-wrap gap-2 mt-2">
                          {datasDoMes.map(data => (
                            <Badge key={data} variant="secondary" className="border-teal-500 text-teal-700">{data}</Badge>
                          ))}
                        </div>
                      ) : (
              ...
              <div className="p-6 bg-gray-50 mt-auto">
                <Button 
                  ...
                  disabled={datasDoMes.length === 0} // Desabilita o botão se não houver datas
                >
